...
typedef enum SC_OperatingModes
{
...
typedef enum SC_OperatingStates
{
...
typedef enum SC_SolenoidStates
{
...
typedef enum KSC_TriggerPortMode
{
...
typedef enum KSC_TriggerPortPolarity
{
