...
/// <summary> Values that represent Travel Modes. </summary>
typedef enum MOT_TravelDirection 
{
...
typedef enum MOT_HomeLimitSwitchDirection 
{
...
typedef enum MOT_DirectionSense 
{
...
typedef enum MOT_LimitSwitchModes 
{
...
/// <summary> Value that represent action to be taken when motor hits a limit switch. </summary>
typedef enum MOT_LimitSwitchSWModes 
{
...
typedef enum MOT_LimitsSoftwareApproachPolicy 
{
...
typedef struct TLI_HardwareInformation
{
	...
	/// <remarks> Each device type has a unique Type ID
	WORD type;
...
/// <seealso cref="TLI_BuildDeviceList()" />
/// <seealso cref="TLI_GetDeviceList(SAFEARRAY** stringsReceiver)" />
void __cdecl TLI_InitializeSimulations();
...
void __cdecl TLI_UninitializeSimulations();
...
short __cdecl ISC_Open(char const * serialNo);
...
void __cdecl ISC_Close(char const * serialNo);
...
short __cdecl ISC_GetHardwareInfo(char const * serialNo, char * modelNo, DWORD sizeOfModelNo, WORD * type, WORD * numChannels, 
...
/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
/// 		  \include CodeSnippet_identify.cpp
short __cdecl ISC_GetHardwareInfoBlock(char const * serialNo, TLI_HardwareInformation *hardwareInfo);
...
/// 		  \include CodeSnippet_identify.cpp
DWORD __cdecl ISC_GetFirmwareVersion(char const * serialNo);
...
/// 		  \include CodeSnippet_identify.cpp
DWORD __cdecl ISC_GetSoftwareVersion(char const * serialNo);
...
void __cdecl ISC_SetCalibrationFile(char const * serialNo, char const *filename, bool enabled);
...
bool __cdecl ISC_IsCalibrationActive(char const * serialNo);
...
/// <seealso cref="ISC_IsCalibrationActive(char const * serialNo)" />
/// <seealso cref="ISC_SetCalibrationFile(char const * serialNo, char const *filename, bool enabled)" />
bool __cdecl ISC_GetCalibrationFile(char const * serialNo, char * filename, short sizeOfBuffer);

/// <summary> Update device with stored settings. </summary>
/// <param name="serialNo"> The device serial no. </param>
/// <returns> <c>true</c> if successful, false if not. </returns>
/// 		  \include CodeSnippet_connection1.cpp
bool __cdecl ISC_LoadSettings(char const * serialNo);
...
/// <returns> <c>true</c> if successful, false if not. </returns>
///             \include CodeSnippet_connection1.cpp
bool __cdecl ISC_LoadNamedSettings(char const * serialNo, char const *settingsName);

/// <summary> persist the devices current settings. </summary>
/// <param name="serialNo">	The device serial no. </param>
/// <returns> <c>true</c> if successful, false if not. </returns>
bool __cdecl ISC_PersistSettings(char const * serialNo);

/// <summary> Reset the stage settings to defaults. </summary>
/// <param name="serialNo"> The device serial no. </param>
/// <returns> <c>true</c> if successful, false if not. </returns>
short __cdecl ISC_ResetStageToDefaults(char const * serialNo);
...
short __cdecl ISC_DisableChannel(char const * serialNo);
...
short __cdecl ISC_EnableChannel(char const * serialNo);
...
int __cdecl ISC_GetNumberPositions(char const * serialNo);
...
/// 		  \include CodeSnippet_move.cpp
short __cdecl ISC_MoveToPosition(char const * serialNo, int index);
...
bool __cdecl ISC_NeedsHoming(char const * serialNo);
...
bool __cdecl ISC_CanMoveWithoutHomingFirst(char const * serialNo);
...
/// <seealso cref="ISC_GetPosition(char const * serialNo)" />
/// 		  \include CodeSnippet_move.cpp
short __cdecl ISC_Home(char const * serialNo);
...
/// <param name="serialNo"> The device serial no. </param>
void __cdecl ISC_ClearMessageQueue(char const * serialNo);
...
void __cdecl ISC_RegisterMessageCallback(char const * serialNo, void (* functionPointer)());
...
/// <seealso cref="ISC_GetNextMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
/// <seealso cref="ISC_WaitForMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
int __cdecl ISC_MessageQueueSize(char const * serialNo);
...
/// <seealso cref="ISC_MessageQueueSize(char const * serialNo)" />
/// <seealso cref="ISC_WaitForMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
bool __cdecl ISC_GetNextMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData);
...
/// <seealso cref="ISC_MessageQueueSize(char const * serialNo)" />
/// <seealso cref="ISC_GetNextMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData)" />
bool __cdecl ISC_WaitForMessage(char const * serialNo, WORD * messageType, WORD * messageID, DWORD *messageData);
...
short __cdecl ISC_RequestHomingParams(char const * serialNo);
...
unsigned int __cdecl ISC_GetHomingVelocity(char const * serialNo);
...
/// <seealso cref="ISC_GetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
/// <seealso cref="ISC_SetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
short __cdecl ISC_SetHomingVelocity(char const * serialNo, unsigned int velocity);
...
/// <seealso cref="ISC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
/// 		  \include CodeSnippet_move.cpp
short __cdecl ISC_MoveRelative(char const * serialNo, int displacement);
...
short __cdecl ISC_RequestJogParams(const char * serialNo);
...
/// 		  \include CodeSnippet_jogpars.cpp
short __cdecl ISC_GetJogMode(char const * serialNo, MOT_JogModes * mode, MOT_StopModes * stopMode);
...
/// <seealso cref="ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
/// 		  \include CodeSnippet_jogpars.cpp
short __cdecl ISC_SetJogMode(char const * serialNo, MOT_JogModes mode, MOT_StopModes stopMode);
...
/// <seealso cref="ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
/// 		  \include CodeSnippet_jogpars.cpp
unsigned int __cdecl ISC_GetJogStepSize(char const * serialNo);
...
/// <seealso cref="ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
/// 		  \include CodeSnippet_jogpars.cpp
short __cdecl ISC_SetJogStepSize(char const * serialNo, unsigned int stepSize);
...
/// <seealso cref="ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
/// 		  \include CodeSnippet_jogpars.cpp
short __cdecl ISC_GetJogVelParams(char const * serialNo, int * acceleration, int * maxVelocity);
...
/// <seealso cref="ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
/// 		  \include CodeSnippet_jogpars.cpp
short __cdecl ISC_SetJogVelParams(char const * serialNo, int acceleration, int maxVelocity);
...
short __cdecl ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection);
...
/// <seealso cref="ISC_GetVelParams(char const * serialNo, int * acceleration, int * maxVelocity)" />
/// <seealso cref="ISC_GetVelParamsBlock(char const * serialNo, MOT_VelocityParameters  *velocityParams)" />
short __cdecl ISC_RequestVelParams(char const * serialNo);
...
short __cdecl ISC_GetVelParams(char const * serialNo, int * acceleration, int * maxVelocity);
...
/// <seealso cref="ISC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
/// 		  \include CodeSnippet_movepars.cpp
short __cdecl ISC_SetVelParams(char const * serialNo, int acceleration, int maxVelocity);
...
/// <seealso cref="ISC_MoveRelative(char const * serialNo, int displacement)" />
/// 		  \include CodeSnippet_move.cpp
short __cdecl ISC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction);
...
void __cdecl ISC_SetDirection(char const * serialNo, bool reverse);
...
short __cdecl ISC_StopImmediate(char const * serialNo);
...
short __cdecl ISC_StopProfiled(char const * serialNo);
...
short __cdecl ISC_RequestBacklash(char const * serialNo);
...
/// <seealso cref="ISC_SetBacklash(char const * serialNo, long distance)" />
long __cdecl ISC_GetBacklash(char const * serialNo);
...
/// <seealso cref="ISC_RequestBacklash(char const * serialNo)" />
/// <seealso cref="ISC_GetBacklash(char const * serialNo)" />
short __cdecl ISC_SetBacklash(char const * serialNo, long distance);
...
long __cdecl ISC_GetPositionCounter(char const * serialNo);
...
/// <seealso cref="ISC_GetPosition(char const * serialNo)" />
short __cdecl ISC_SetPositionCounter(char const * serialNo, long count);
...
short __cdecl ISC_RequestLimitSwitchParams(char const * serialNo);
...
/// <seealso cref="ISC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
short __cdecl ISC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode);
...
/// <seealso cref="ISC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
/// <seealso cref="ISC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
short __cdecl ISC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode);
...
MOT_LimitsSoftwareApproachPolicy __cdecl ISC_GetSoftLimitMode(char const * serialNo);
...
void __cdecl ISC_SetLimitsSoftwareApproachPolicy(char const * serialNo, MOT_LimitsSoftwareApproachPolicy limitsSoftwareApproachPolicy);
...
short __cdecl ISC_RequestButtonParams(char const * serialNo);
...
/// <seealso cref="ISC_GetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams)" />
short __cdecl ISC_GetButtonParams(char const * serialNo, MOT_ButtonModes * buttonMode, int * leftButtonPosition, int * rightButtonPosition, short * timeout);
...
/// <seealso cref="ISC_SetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams)" />
/// <seealso cref="ISC_GetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams)" />
short __cdecl ISC_SetButtonParams(char const * serialNo, MOT_ButtonModes buttonMode, int leftButtonPosition, int rightButtonPosition);
...
short __cdecl ISC_RequestPotentiometerParams(char const * serialNo);
...
/// <seealso cref="ISC_SetPotentiometerParams(char const * serialNo, short index, WORD thresholdDeflection, DWORD velocity)" />
short __cdecl ISC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity);
...
/// <seealso cref="ISC_RequestPotentiometerParams(char const * serialNo)" />
/// <seealso cref="ISC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity)" />
short __cdecl ISC_SetPotentiometerParams(char const * serialNo, short index, WORD thresholdDeflection, DWORD velocity);
...
/// <seealso cref="ISC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
/// 		  \include CodeSnippet_movepars.cpp
short __cdecl ISC_GetVelParamsBlock(const char * serialNo, MOT_VelocityParameters  *velocityParams);
...
/// <seealso cref="ISC_MoveAtVelocity(char const * serialNo, MOT_TravelDirection direction)" />
/// 		  \include CodeSnippet_movepars.cpp
short __cdecl ISC_SetVelParamsBlock(const char * serialNo, MOT_VelocityParameters *velocityParams);
...
short __cdecl ISC_SetMoveAbsolutePosition(const char * serialNo, int position);
...
/// <seealso cref="ISC_MoveAbsolute(const char * serialNo)" />
short __cdecl ISC_RequestMoveAbsolutePosition(char const * serialNo);
...
/// <seealso cref="ISC_SetMoveAbsolutePosition(const char * serialNo, int position)" />
/// <seealso cref="ISC_MoveAbsolute(const char * serialNo)" />
int __cdecl ISC_GetMoveAbsolutePosition(const char * serialNo);
...
/// <seealso cref="ISC_SetMoveAbsolutePosition(const char * serialNo, int position)" />
/// <seealso cref="ISC_GetMoveAbsolutePosition(const char * serialNo)" />
short __cdecl ISC_MoveAbsolute(const char * serialNo);
...
short __cdecl ISC_SetMoveRelativeDistance(const char * serialNo, int distance);
...
/// <seealso cref="ISC_MoveRelativeDistance(const char * serialNo)" />
short __cdecl ISC_RequestMoveRelativeDistance(char const * serialNo);
...
/// <seealso cref="ISC_SetMoveRelativeDistance(const char * serialNo, int distance)" />
/// <seealso cref="ISC_MoveRelativeDistance(const char * serialNo)" />
int __cdecl ISC_GetMoveRelativeDistance(const char * serialNo);
...
/// <seealso cref="ISC_SetMoveRelativeDistance(const char * serialNo, int distance)" />
/// <seealso cref="ISC_GetMoveRelativeDistance(const char * serialNo)" />
short __cdecl ISC_MoveRelativeDistance(const char * serialNo);
...
/// <seealso cref="ISC_SetHomingVelocity(char const * serialNo, unsigned int velocity)" />
/// <seealso cref="ISC_SetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
short __cdecl ISC_GetHomingParamsBlock(const char * serialNo, MOT_HomingParameters *homingParams);
...
/// <seealso cref="ISC_SetHomingVelocity(char const * serialNo, unsigned int velocity)" />
/// <seealso cref="ISC_GetHomingParamsBlock(char const * serialNo, MOT_HomingParameters *homingParams)" />
short __cdecl ISC_SetHomingParamsBlock(const char * serialNo, MOT_HomingParameters *homingParams);
...
/// <seealso cref="ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
/// 		  \include CodeSnippet_jogpars.cpp
short __cdecl ISC_GetJogParamsBlock(const char * serialNo, MOT_JogParameters *jogParams);
...
/// <seealso cref="ISC_MoveJog(char const * serialNo, MOT_TravelDirection jogDirection)" />
/// 		  \include CodeSnippet_jogpars.cpp
short __cdecl ISC_SetJogParamsBlock(const char * serialNo, MOT_JogParameters *jogParams);
...
/// <seealso cref="ISC_GetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes * clockwiseHardwareLimit, MOT_LimitSwitchModes * anticlockwiseHardwareLimit, unsigned int * clockwisePosition, unsigned int * anticlockwisePosition, MOT_LimitSwitchSWModes * softLimitMode)" />
/// <seealso cref="ISC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
short __cdecl ISC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams);
...
/// <seealso cref="ISC_SetLimitSwitchParams(char const * serialNo, MOT_LimitSwitchModes clockwiseHardwareLimit, MOT_LimitSwitchModes anticlockwiseHardwareLimit, unsigned int clockwisePosition, unsigned int anticlockwisePosition, MOT_LimitSwitchSWModes softLimitMode)" />
/// <seealso cref="ISC_GetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams)" />
short __cdecl ISC_SetLimitSwitchParamsBlock(const char * serialNo, MOT_LimitSwitchParameters *limitSwitchParams);
...
/// <seealso cref="ISC_RequestButtonParams(char const * serialNo)" />
/// <seealso cref="ISC_GetButtonParams(char const * serialNo, MOT_ButtonModes * buttonMode, int * leftButtonPosition, int * rightButtonPosition, short * timeout)" />
short __cdecl ISC_GetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams);
...
/// <seealso cref="ISC_GetButtonParams(char const * serialNo, MOT_ButtonModes * buttonMode, int * leftButtonPosition, int * rightButtonPosition, short * timeout)" />
/// <seealso cref="ISC_SetButtonParams(char const * serialNo, MOT_ButtonModes buttonMode, int leftButtonPosition, int rightButtonPosition)" />
short __cdecl ISC_SetButtonParamsBlock(const char * serialNo, MOT_ButtonParameters *buttonParams);
...
/// <seealso cref="ISC_RequestPotentiometerParams(char const * serialNo)" />
/// <seealso cref="ISC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity)" />
short __cdecl ISC_GetPotentiometerParamsBlock(const char * serialNo, MOT_PotentiometerSteps *potentiometerSteps);
...
/// <seealso cref="ISC_SetPotentiometerParams(char const * serialNo, short index, WORD thresholdDeflection, DWORD velocity)" />
/// <seealso cref="ISC_GetPotentiometerParams(char const * serialNo, short index, WORD * thresholdDeflection, DWORD * velocity)" />
short __cdecl ISC_SetPotentiometerParamsBlock(const char * serialNo, MOT_PotentiometerSteps *potentiometerSteps);
...
short __cdecl ISC_RequestPowerParams(char const * serialNo);
...
/// <seealso cref="ISC_SetPowerParams(const char * serialNo, MOT_PowerParameters *powerParams)" />
short __cdecl ISC_GetPowerParams(const char * serialNo, MOT_PowerParameters *powerParams);
...
/// <seealso cref="ISC_RequestPowerParams(char const * serialNo)" />
/// <seealso cref="ISC_GetPowerParams(const char * serialNo, MOT_PowerParameters *powerParams)" />
short __cdecl ISC_SetPowerParams(const char * serialNo, MOT_PowerParameters *powerParams);
...
short __cdecl ISC_RequestBowIndex(char const * serialNo);
...
/// <seealso cref="ISC_SetBowIndex(const char * serialNo, short bowIndex)" />
short __cdecl ISC_GetBowIndex(const char * serialNo);
...
/// <seealso cref="ISC_RequestBowIndex(char const * serialNo)" />
/// <seealso cref="ISC_GetBowIndex(const char * serialNo)" />
short __cdecl ISC_SetBowIndex(const char * serialNo, short bowIndex);
...
short __cdecl ISC_RequestTriggerSwitches(char const * serialNo);
...
byte __cdecl ISC_GetTriggerSwitches(char const * serialNo);
...
short __cdecl ISC_SetTriggerSwitches(char const * serialNo, byte indicatorBits);
...
short __cdecl ISC_RequestPosition(char const * serialNo);
...
/// <seealso cref="ISC_StartPolling(char const * serialNo, int milliseconds)" />
short __cdecl ISC_RequestStatusBits(char const * serialNo);
...
/// <seealso cref="ISC_GetStatusBits(char const * serialNo)" />
/// <seealso cref="ISC_StartPolling(char const * serialNo, int milliseconds)" />
short __cdecl ISC_RequestStatus(char const * serialNo);
...
/// <seealso cref="ISC_StartPolling(char const * serialNo, int milliseconds)" />
DWORD __cdecl ISC_GetStatusBits(char const * serialNo);
...
/// <seealso cref="ISC_RequestPosition(char const * serialNo)" />
/// \include CodeSnippet_connection1.cpp
bool __cdecl ISC_StartPolling(char const * serialNo, int milliseconds);
...
/// <seealso cref="ISC_StopPolling(char const * serialNo)" />
/// \include CodeSnippet_connection1.cpp
long __cdecl ISC_PollingDuration(char const * serialNo);
...
/// <seealso cref="ISC_PollingDuration(char const * serialNo)" />
/// \include CodeSnippet_connection1.cpp
void __cdecl ISC_StopPolling(char const * serialNo);
...
// bool __cdecl ISC_TimeSinceLastMsgReceived(char const * serialNo, __int64 &lastUpdateTimeMS );
...
/// <seealso cref="ISC_HasLastMsgTimerOverrun(char const * serialNo)" />
/// \include CodeSnippet_connectionMonitoring.cpp
// void __cdecl ISC_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout );
...
/// <seealso cref="ISC_EnableLastMsgTimer(char const * serialNo, bool enable, __int32 lastMsgTimeout )" />
/// \include CodeSnippet_connectionMonitoring.cpp
bool __cdecl ISC_HasLastMsgTimerOverrun(char const * serialNo);
...
/// <param name="serialNo">	The device serial no. </param>
/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successfully requested. </returns>
short __cdecl ISC_RequestSettings(char const * serialNo);
...
int __cdecl ISC_GetStageAxisMinPos(char const * serialNo);
...
int __cdecl ISC_GetStageAxisMaxPos(char const * serialNo);
...
/// <seealso cref="ISC_GetStageAxisMinPos(char const * serialNo)" />
/// <seealso cref="ISC_GetStageAxisMaxPos(char const * serialNo)" />
short __cdecl ISC_SetStageAxisLimits(char const * serialNo, int minPosition, int maxPosition);
...
short __cdecl ISC_SetMotorTravelMode(char const * serialNo, MOT_TravelModes travelMode);
...
MOT_TravelModes __cdecl ISC_GetMotorTravelMode(char const * serialNo);
...
short __cdecl ISC_SetMotorParams(char const * serialNo, long stepsPerRev, long gearBoxRatio, float pitch);
...
short __cdecl ISC_GetMotorParams(char const * serialNo, long *stepsPerRev, long *gearBoxRatio, float *pitch);
...
short __cdecl ISC_SetMotorParamsExt(char const * serialNo, double stepsPerRev, double gearBoxRatio, double pitch);
...
short __cdecl ISC_GetMotorParamsExt(char const * serialNo, double *stepsPerRev, double *gearBoxRatio, double *pitch);
...
short __cdecl ISC_SetMotorVelocityLimits(char const * serialNo, double maxVelocity, double maxAcceleration);
...
short __cdecl ISC_GetMotorVelocityLimits(char const * serialNo, double *maxVelocity, double *maxAcceleration);
...
short __cdecl ISC_ResetRotationModes(char const * serialNo);
...
short __cdecl ISC_SetRotationModes(char const * serialNo, MOT_MovementModes mode, MOT_MovementDirections direction);
...
short __cdecl ISC_SetMotorTravelLimits(char const * serialNo, double minPosition, double maxPosition);
...
short __cdecl ISC_GetMotorTravelLimits(char const * serialNo, double *minPosition, double *maxPosition);
...
short __cdecl ISC_GetRealValueFromDeviceUnit(char const * serialNo, int device_unit, double *real_unit, int unitType);
...
short __cdecl ISC_GetDeviceUnitFromRealValue(char const * serialNo, double real_unit, int *device_unit, int unitType);
